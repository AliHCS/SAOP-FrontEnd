...
const viewName = "Catálogo de Módulos";
const searchTerm = ref("");
const { arrayData, getDatas, searchData } = usePetition("cat_modulo/");

const handleCreate = () => router.push({ name: "crear_modulo" });
const handleEdit = (data: string) =>
  router.push({ name: "editar_modulo", params: { id: data } });
