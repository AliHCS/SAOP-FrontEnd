...
const viewName = "Catálogo Moneda";
const searchTerm = ref("");
const { arrayData, getDatas, searchData } = usePetition("cat_moneda/");

const handleCreate = () => router.push({ name: "crear-cat_moneda" });
const handleEdit = (data: string) =>
  router.push({ name: "editar-cat_moneda", params: { id: data } });
