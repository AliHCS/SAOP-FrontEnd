...
const viewName = 'Tipo Escalatoria'
const { arrayData, getDatas, searchData } = usePetition("cat_tipo_escalatoria/");
const searchText = ref<string>('')
const showView = ref(false)
const handleCreate = () => router.push({ name: 'crear-tipo-escalatoria' })
const handleEdit = (data: any) => router.push({ name: 'editar-tipo-escalatoria', params: { id: data } })
const handleDelete = (data: any) => router.push({ name: 'eliminar-tipo-escalatoria', params: { id: data } })
