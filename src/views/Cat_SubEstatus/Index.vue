...
const viewName = "Catálogo Sub-Estatus";
const searchTerm = ref("");
const { arrayData, getDatas, searchData } = usePetition("cat_subestatus/");

const handleCreate = () => router.push({ name: "crear-cat_subEstatus" });
const handleEdit = (data: string) =>
  router.push({ name: "editar-cat_subEstatus", params: { id: data } });
...
const columns = [
  ...
  { title: "Descripción Subestatus", data: "descripcion_subestatus" },
  { title: "Fecha Subestatus", data: "fecha_subestatus" },
  { title: "Estatus Subestatus", data: "estatus_subestatus" },
