...
const viewName = "Catálogo Idioma";
const searchTerm = ref("");
const { arrayData, getDatas, searchData } = usePetition("cat_idioma/");

const handleCreate = () => router.push({ name: "crear-cat_idioma" });
const handleEdit = (data: string) =>
  router.push({ name: "editar-cat_idioma", params: { id: data } });
