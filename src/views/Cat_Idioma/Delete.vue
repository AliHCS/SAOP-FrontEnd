<template>
  ...
  <CardConfirmComponent
    title="¿Estás Seguro?"
    subtitle="El idioma se dará de baja permanentemente."
...
const viewName = "Eliminar Idioma";
const { deleteData, getData } = usePetition("cat_idioma/");
const handleCancel = () => router.push({ name: "listar-cat_idioma" });
const handleConfirm = () =>
